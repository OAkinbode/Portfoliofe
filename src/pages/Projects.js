        ...
        >
          ...
          <Link to="/GrabAJoke">
            <div className="px-4 ">
              <Textcontainer
                title="Grab a Joke"
                body="This game is built in Node.js/MongoDB and in React.js. Click to go grab-a-joke!"
                image={Jokes}
              />
            </div>
          </Link>
          ...
          >
            <div className="px-4">
              <Textcontainer
                ...
                body="An application that allows users to make reservations at cinemas. Written in a React frontend and Spring Boot Backend"
                image={Ticket}
              />
            </div>
          </a>
